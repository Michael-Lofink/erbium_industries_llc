...
**Languages** Madrosarai, telepathy 30 feet
...
**Ranged** `pf2:1` rotating  pistol (agile, concealable, concussive, range increment 60 feet), **Damage** 1d6 piercing
**A.E.D. shot (magical,healing,vitality)** `pf2:2` **Frequency** once per minute **Effect** Attempt a recovery check for an ally with the dying condition within the first range increment by shooting them with a taser bullet. On a successs, the ally recovers from the dying condition normally, and regains one hit point.
...
# Commerical Rotating Pistol
## Level 0
==Agile== ==Analog== ==Concealable== ==Concussive==
**Source** Player Core pg. 266
**Price** 30 credits; **Damage** 1d6 P; **Bulk** L
**Hands** 1; **Range** 60ft.; **Reload** 1
**Type** Ranged; **Category** Martial; **Group** Projectile
**Upgrades** 1; **Magazine** 6 projectiles; **Expend** 1
